...
KEYRING=edgen          # remember to change to other types of keyring like 'file' in-case exposing to outside world, otherwise your balance will be wiped quickly. The keyring test does not require private key to steal tokens from you
...
# Change parameter token denominations to aedgen
...
evmd genesis add-genesis-account "$(evmd keys show "$VAL_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 100000000000000000000000000aedgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER1_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000aedgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER2_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000aedgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER3_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000aedgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER4_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000aedgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
...
evmd genesis gentx "$VAL_KEY" 1000000000000000000000aedgen --gas-prices ${BASEFEE}aedgen --keyring-backend "$KEYRING" --chain-id "$CHAINID" --home "$CHAINDIR"
...
evmd start "$TRACE" \
	--log_level $LOGLEVEL \
	--minimum-gas-prices=0.0001uedgen \
